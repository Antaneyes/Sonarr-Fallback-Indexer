    ...
    public class SeriesSearchServiceFixture : CoreTest<SeriesSearchService>
    {
        ...
        public void should_start_with_lower_seasons_first()
        {
            ...
            Mocker.GetMock<ISearchForReleases>()
                  ...
                  .Returns(Task.FromResult(new List<DownloadDecision>()))
                  .Callback<int, int, bool, bool, bool, bool, bool>((seriesId, seasonNumber, missingOnly, monitoredOnly, userInvokedSearch, interactiveSearch, includeFallback) => seasonOrder.Add(seasonNumber));
